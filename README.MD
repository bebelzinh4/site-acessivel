...
<body>
    ...
    <main class="container my-5">
        ...
        <section id="Sorriso Real" class="my-5 pt-6 secao-sorriso Real" tabindex="0" aria-label="Seção explicativa sobre a Cachos">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center ">
                    <img src="img/image (1).png" class="rounded-pill" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>O que foi a Sorriso Real?</h2>
                    <p class="p-2">O Sorriso Real surgiu da dificuldade de encontrar um creme para finalização de cachos, assim desenvolvi uma fórmula de qualidade para uma finalização impecável</p>
                </div>
            </div>
        </section>
